/* ================================================================
   blooket-builder.js — Blooket review grid + set card rendering.
   Loaded after app.js (which provides state, helpers, icons, theme).
   This file owns the review grid (loadBlooketClasses, renderReviewGrid,
   renderBlooketClassCard, renderSetCard, renderCustomSetsSection,
   populateCustomBlooketTarget, renderCustomBlooketSets).
   ================================================================ */
